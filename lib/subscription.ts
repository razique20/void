...
export const PLANS = {
  ...
  starter: {
    ...
    maxWorkers: 2,
    maxMessages: 1000,
    features: ['basic_rag', 'web_chat', 'whatsapp', 'telegram', 'memory', 'mission_control', 'sheets'],
  ...
  pro: {
    ...
    maxWorkers: 5,
    maxMessages: 5000,
    features: ['basic_rag', 'web_chat', 'whatsapp', 'telegram', 'memory', 'mission_control', 'marketplace', 'priority_support', 'whatsapp_catalog', 'sheets'],
  ...
  enterprise: {
    ...
    maxWorkers: 20,
    maxMessages: 25000,
    features: ['advanced_rag', 'web_chat', 'whatsapp', 'telegram', 'slack', 'memory', 'mission_control', 'marketplace', 'email_agent', 'actions_webhooks', 'cal_booking', 'smart_booking', 'autonomous_goals', 'knowledge_sharing', 'conversation_branching', 'natural_language_analytics', 'lead_capture', 'dedicated_support', 'smart_routing', 'whatsapp_catalog', 'sheets'],
