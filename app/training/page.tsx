              ...
              {workers.length === 0 && !isRefreshing && (
                <div className="flex flex-col items-center justify-center py-16 bg-foreground/[0.01] dark:bg-white/[0.005] border border-foreground/[0.06] dark:border-white/[0.06] border-dashed rounded-2xl text-center">
                  ...
                  <p className="text-silver text-xs max-w-sm mt-1.5 leading-relaxed">
                    You need at least one operative before you can inject knowledge. Deploy your first AI agent to get started.
                  </p>
                  <Link
                    href="/create-worker"
                  ...
                  >
                    <Plus className="w-3.5 h-3.5" /> Deploy First Operative
                  </Link>
                </div>
              )}
