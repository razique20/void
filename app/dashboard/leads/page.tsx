...
import { Download, Search, CheckCircle, Clock, XCircle, FileText, ChevronRight, Check, Sparkles, Database, Circle, RefreshCw } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 relative z-10">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button 
            ...
            className="w-12 h-12 md:w-auto md:h-auto md:px-5 md:py-3.5 bg-foreground/[0.03] dark:bg-white/[0.02] text-foreground border border-foreground/[0.05] dark:border-white/[0.05] rounded-full text-xs font-bold hover:bg-foreground/[0.06] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            title="Refresh Leads"
          >
